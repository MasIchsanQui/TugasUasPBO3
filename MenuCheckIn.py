...
"}")
        ...
        self.BtnEdit_2.clicked.connect(self.ClickedCheckIn)
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.LabelTittle.setText(_translate("Form", "FORM CHECK IN HOTEL MADRIDISTAS"))
        self.BtnEdit_2.setText(_translate("Form", "CHECK IN"))
